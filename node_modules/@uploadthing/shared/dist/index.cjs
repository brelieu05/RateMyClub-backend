 ...
 */ const fillInputRouteConfig = (routeConfig)=>{
    ...
    return Micro__namespace.succeed(newConfig);
};
 ...
 */ const exponentialDelay = ()=>Function.pipe(Micro__namespace.delayExponential(10, 4), Micro__namespace.delayWithMax(1000), Micro__namespace.delayWithMaxElapsed(60_000));
